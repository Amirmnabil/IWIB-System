...
export const sampleInsuranceCompanies: InsuranceCompany[] = [
    { id: 'insurer_1', name: 'EL-Misria Takaful', code: 'EMT', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_2', name: 'Mohandes', code: 'MOH', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_3', name: 'Misr Insurance', code: 'MI', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_4', name: 'Wethaq', code: 'WET', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_5', name: 'Royal', code: 'ROY', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_6', name: 'Delta Insurance', code: 'DEL', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_7', name: 'Labano-suisse', code: 'LBS', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_8', name: 'Gig', code: 'GIG', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_9', name: 'Arope', code: 'ARO', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_10', name: 'Allianz', code: 'ALZ', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_11', name: 'Orient takaful', code: 'ORT', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_12', name: 'Bupa', code: 'BUP', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_13', name: 'Chubb', code: 'CHU', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_14', name: 'Sarwa Insurance', code: 'SAR', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_15', name: 'Metlife', code: 'MET', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_16', name: 'Axa', code: 'AXA', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_17', name: 'Watania', code: 'WAT', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_18', name: 'Salama', code: 'SAL', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_19', name: 'Mada', code: 'MAD', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_20', name: 'Sarwa General', code: 'SGN', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_21', name: 'Kaf Life', code: 'KFL', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_22', name: 'Misr Insurance Takful', code: 'MIT', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_23', name: 'Wafa Life', code: 'WFL', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_24', name: 'Suez Canal Insurance', code: 'SCI', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_25', name: 'GIG Takaful', code: 'GIGT', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_26', name: 'Iskan Insurance', code: 'ISK', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_27', name: 'Misr Ins Life', code: 'MIL', status: 'active', created_at: new Date().toISOString() },
    { id: 'insurer_28', name: 'Mohandes Life', code: 'MOHL', status: 'active', created_at: new Date().toISOString() },
];
