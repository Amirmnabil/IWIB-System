        ...
        <Slide className="is-cover bg-slate-900 text-white p-0">
          ...
          <div className="relative z-10 flex flex-col h-full p-24 justify-center max-w-3xl">
            ...
            <div className="grid grid-cols-2 gap-8 border-t border-white/10 pt-12">
              <div>
                <p className="text-slate-500 font-bold uppercase tracking-widest text-[10px] mb-2">{t('proposalName')}</p>
                <p className="text-xl font-bold text-white">{offerName}</p>
              </div>
              <div>
                <p className="text-slate-500 font-bold uppercase tracking-widest text-[10px] mb-2">{t('issueDate')}</p>
            ...
            <div className="flex gap-16 items-center">
              <div className="w-1/2 space-y-8">
                <h2 className="text-5xl font-black text-slate-900 leading-tight">
                  {t('beyondJust')} <span className="text-indigo-600">{t('coverage')}</span>
                </h2>
                ...
                <div className="grid grid-cols-1 gap-6">
                  <div className="flex gap-5 items-start bg-slate-50 p-6 rounded-2xl border border-slate-100">
                    ...
                    <div>
                      <h4 className="text-lg font-bold text-slate-900 mb-1">{t('financialOptimization')}</h4>
                      <p className="text-sm text-slate-500">{t('financialOptDesc')}</p>
                    </div>
                  </div>
                  <div className="flex gap-5 items-start bg-slate-50 p-6 rounded-2xl border border-slate-100">
                    ...
                    <div>
                      <h4 className="text-lg font-bold text-slate-900 mb-1">{t('riskMitigation')}</h4>
                      <p className="text-sm text-slate-500">{t('riskMitigationDesc')}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex-1 flex flex-col">
              <div className="mb-4 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-slate-500 font-medium">{t('comparisonSub')}</p>
                </div>
                  ...
                  <thead>
                    <tr className="bg-slate-50 border-b border-slate-200">
                      <th className="p-4 text-left w-1/4">
                        ...
                        <div className="text-sm font-bold text-slate-900">{t('coreCoverageAreas')}</div>
                      </th>
                      {chunk.map((p, i) => (
          ...
          <div className="grid grid-cols-2 gap-12 flex-1">
            <div className="flex flex-col">
              <div className="mb-6">
                ...
                <p className="text-xs text-slate-500">{t('premiumEfficiencyDesc')}</p>
              </div>
            ...
            <div className="flex flex-col">
              <div className="mb-6">
                ...
                <p className="text-xs text-slate-500">{t('benefitCapacityDesc')}</p>
              </div>
              <div className="flex-1 bg-slate-50 rounded-3xl p-8 border border-slate-100">
                <ResponsiveContainer width="100%" height="100%">
        ...
        <Slide title="Strategic Partnership" className="bg-slate-50">
          <div className="flex-1 flex gap-16 items-center">
            <div className="w-1/2 space-y-12">
              <div>
                <h2 className="text-5xl font-black text-slate-900 mb-6">{t('letsSecureFuture')}</h2>
